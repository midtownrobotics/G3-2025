...
public class CoralOuttakePivotConstants {
    ...
    public static final Angle absoluteEncoderOffset = Degrees.of(200.9);
    ...
    public final class PID {
        ...
        public static final LoggedTunableNumber maxPivotV = new LoggedTunableNumber("CoralOuttake/maxV", 0);
        public static final LoggedTunableNumber maxPivotA = new LoggedTunableNumber("CoralOuttake/maxA", 0);
    }
}
