...
public class PivotIOSim implements PivotIO {
   ...
   */
  public PivotIOSim() {
    m_sim = new SingleJointedArmSim(DCMotor.getNEO(1), 20, SingleJointedArmSim.estimateMOI(Units.inchesToMeters(10), 1.5), Units.inchesToMeters(10), Units.degreesToRadians(-10), Units.degreesToRadians(135), true, 0, 0.001, 0.001);
  }
