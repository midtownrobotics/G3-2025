...
public class CoralIntakeConstants {
    ...
    public static final Angle absoluteEncoderOffset = Radians.of(6.056);
    ...
    public final class PID {
        ...
        public static final LoggedTunableNumber p = new LoggedTunableNumber("CoralIntake/p", 3.95);
        public static final LoggedTunableNumber i = new LoggedTunableNumber("CoralIntake/i", 0.02);
