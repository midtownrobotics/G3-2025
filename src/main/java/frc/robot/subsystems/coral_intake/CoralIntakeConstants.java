...
public class CoralIntakeConstants {
    ...
    public static final Angle absoluteEncoderOffset = Radians.of(3.469);
    ...
    public final class PID {
        ...
        public static final LoggedTunableNumber d = new LoggedTunableNumber("CoralIntake/d", 1);

        public static final LoggedTunableNumber maxPivotV = new LoggedTunableNumber("CoralIntake/maxV", 10);
        public static final LoggedTunableNumber maxPivotA = new LoggedTunableNumber("CoralIntake/maxA", 30);
