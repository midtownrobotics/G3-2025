...
public interface WristIO {
  ...
  public class WristConfig {
    // private LoggedTunableNumber p, i, d, s, g, a, v, currentLimit, currentLowerLimit, currentLowerTime;
    private LoggedTunableNumber currentLimit, currentLowerLimit, currentLowerTime;
    // private LoggedTunableNumber[] constants = new LoggedTunableNumber[]{p, i, d, s, g, a, v, currentLimit, currentLowerLimit, currentLowerTime};
    private LoggedTunableNumber[] constants = new LoggedTunableNumber[]{currentLimit, currentLowerLimit, currentLowerTime};
    /**
