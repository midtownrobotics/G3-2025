...
public class VisionConstants {
  ...
  public static final String kTagCameraOnAStickCameraName = "limelight-nick";
  ...
  public static final Transform3d kTagCameraOnAStickRobotToCamera = new Transform3d(
  ...
  public static final Transform3d kModuleTagCameraPositionCorrection = new Transform3d(
      new Translation3d(-0.01, -0.01, -0.02),
      new Rotation3d(
          new Quaternion(0.007873324823506722, 0.008373276697295224, 0.023013205671960246, -0.9996690909287304)))
      .inverse();
